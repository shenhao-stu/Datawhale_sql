...
![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.01view.png)
...
![图片](https://gitee.com/shenhao-stu/picgo/raw/master/Others/ch03.02view2.png)
...
![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.03view3.png)
...
![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.04view4.png)
...
![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.05result.png)
...
![图片](https://gitee.com/shenhao-stu/picgo/raw/master/Others/ch03.06productsum.png)
...
![图片](https://gitee.com/shenhao-stu/picgo/raw/master/Others/ch03.07productsum2.png)

此时观察原表也可以发现数据也被更新了

![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.08productsumsrc.png)
...
<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124151723640.png" style="zoom:50%;" />
...
![图片](https://gitee.com/shenhao-stu/picgo/raw/master/Others/ch03.09case.png)
...
<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124163038679.png" alt="image-20211124163038679" style="zoom:50%;" />
...
```
<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124163158396.png" alt="image-20211124163158396" style="zoom:50%;" />
...
<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124163703908.png" alt="image-20211124163703908" style="zoom:50%;" />
...
<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124173720586.png" alt="image-20211124173720586" style="zoom:50%;" />
...
![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.10function.png)
...
![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.11casewhen1.png)

计划得到如下的图表结构

![图片](https://raw.fastgit.org/datawhalechina/team-learning-sql/main/img/ch03/ch03.12casewhen2.png)
...
```
<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124200952145.png" alt="image-20211124200952145" style="zoom: 50%;" />
...
```
<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124201103913.png" alt="image-20211124201103913" style="zoom:50%;" />

<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124201535031.png" alt="image-20211124201535031" style="zoom:50%;" />

> **思考：**
>
> anything(包括NULL) in (NULL) 为NULL，anything not in (NULL)为NULL。
>
> 因此purchase_price NOT IN (500, 2800, 5000, NULL)结果始终为NULL，not in 500 and not in 2800 and not in 5000 and **not in NULL** => NULL。
...
SELECT
	...
	COUNT( CASE WHEN sale_price BETWEEN 1001 AND 3000 THEN 1 END ) AS mid_price,
	COUNT( CASE WHEN sale_price >= 3001 THEN 1 END ) AS high_price 
FROM
	product;
```

<img src="https://gitee.com/shenhao-stu/picgo/raw/master/Others/image-20211124202739806.png" alt="image-20211124202739806" style="zoom:50%;" />
