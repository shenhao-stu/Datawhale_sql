...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.01and.png)

OR运算符工作效果图

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.02or.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.03true.png)

查询条件为P AND（Q OR R）的真值表

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.04true2.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.05true3.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.06cut.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.07groupby.png)
...
办公用品      |  600 | 320
```
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.08test26.png)

### 2.7

此前我们曾经使用SELECT语句选取出了product（商品）表中的全部记录。当时我们使用了ORDERBY子句来指定排列顺序，但现在已经无法记起当时如何指定的了。请根据下列执行结果，思考ORDERBY子句的内容。

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch02/ch02.09test27.png)
