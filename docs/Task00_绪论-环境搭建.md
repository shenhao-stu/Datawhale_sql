...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0001.png)

在下载页面选择下方的不注册,仅下载.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0002.png)

完成下载后, 得到一个后缀为msi的安装文件.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0003.png)

### 1.1.2 安装

找到刚才下载好的msi文件, 双击开始安装. 初学者建议采用完全安装模式(Full)进行安装:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0004.png)

选择安装路径和数据存放路径, 二者都可以选择在非系统盘(注意要点击最右侧的按钮进行选择, 不要直接在文本框中修改安装路径).

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0005.png)

完全安装模式下, 部分模块会依赖其他其他组件(每台电脑上列出的依赖项很可能会有不同).

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0006.png)

如果你的电脑之前没有安装过这些组件, 则需要额外进行安装, 此处点击 Execute 按钮即可:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0007.png)

在这些所依赖的组件的安装过程中, 只需要一路选择"同意"并逐个安装就可以了:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0008.png)

安装好⼀个组件后, 点击关闭按钮, ⾃动开始安装下⼀个组件(这一步根据操作系统版本可能会略有不同)

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0009.png)

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0010.png)

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0011.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0012.png)

如果有个别组件未安装成功, 此时可以先选择 Yes, 忽略个别组件的安装.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0013.png)

点击 Excute, 开始安装服务器软件MySQL Server, 连接和查询软件MySQL Workbench及其他相关软件等内容.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0014.png)

稍等片刻,  安装完成后, 点击 Next

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0015.png)

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0016.png)

下图这一步是选是否以集群方式安装 MySQL, 我们选择默认的第一个, 然后点击 Next:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0017.png)

此处上边的各种相关配置保持默认即可,**勾选最下边的"Show Advanced and Logging Options"框,**然后点击 Next:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0018.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0019.png)

在这一步设置 MySQL 的 root 账户密码, 由于上一步选择了第二个选项, 因此这里可以设置为较简单容易记忆的而密码, 例如"123456". 建议设置⽐较简单的密码, 并将密码记录下来以防遗忘, 忘记密码是⼀件麻烦事.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0020.png)

此处保持默认即可, 如果 windows service name 右侧有⻩⾊警告图标显示, 表示名称重复, ⼿动更换⼀个名称即可, 然后点击 Next:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0021.png)

Logging Options 这里使用默认设置即可, 我们的学习中暂时用不到这些设置, 直接点击 Next:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0022.png)

下图是设置是否大小写敏感的. 这一步非常重要,**由于windows系统是大小写不敏感的, 请大家务必使用第一个选项Lower Case**.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0023.png)

点击 Execute

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0024.png)

完成安装后, 在下图中点击 Finish 回到安装的主进程:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0025.png)

在主进程界面点击 Next

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0026.png)

这一步无需任何选择, 直接点击 Finish

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0027.png)

进入到 Connect To Server 界面后, 输⼊刚才设置的密码, 点击 check 进⾏校验, 校验通过后 Status 会显示连接成功, 然后点击 Next

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0028.png)

点击 Excute 应用设置:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0029.png)

上述步骤完成后, 点击 Finish

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0030.png)

回到安装主进程后, 点击 Next

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0031.png)

点击 Finish,完成安装.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0032.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0033.png)

然后选择下载dmg安装文件.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0034.png)

点击下方的直接下载.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0035.png)

下载的文件为:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0036.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0037.png)

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0038.png)

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0039.png)

注意, 在配置MySQL服务器这一步, 最好选择下边的选项, 这样就可以使用简单密码.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0040.png)

在 Configuration 接下来的步骤需要设置密码, 如果上一步选择了第二个选项, 这里就可以使用比较简单的密码. 请务必牢记自己设置的密码.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0041.png)

注意, 如果在前一步选择使用了MySQL8.0强密码, MySQL安装过程中会自动生成一个随机密码, 类似于下图这种形式:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0042.png)

此时请截图保留该密码, 并在安装完成后, 使用该密码登录并重新设置密码. 由于选择使用了强密码, 此时设置密码必须使用大小写字母数字和特殊符号的组合.

完成安装后, 打开电脑的系统偏好设置, 会出现MySQL的服务标识.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0043.png)

正确安装MySQL后, 打开上述截图中的MySQL之后会看到如下界面, 在这里可以启动和停止MySQL服务, 以及配置MySQL是否随电脑启动而自动启动.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0044.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0045.png)
...
```
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0046.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0047.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0048.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0049.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0050.png)
...
```
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0051.png)
...
```
查看初始的随机密码:
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0052.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0053.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0054.png)

原因是因为 MySQL 有密码设置的规范, 具体是与 validate_password_policy 的值有关：

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch00541.png)

MySQL 完整的初始密码规则可以通过如下命令查看：

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0055.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0056.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0057.png)

输⼊你在安装过程中为root用户设置的密码即可连接到数据库, 看到如下界⾯, 表示数据库安装成功,并且你已经使用命令行连接到了数据库(图中红框表示数据库版本), 在最后的 "mysql>" 后即可输入SQL命令执行各种数据库操作.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0058.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0059.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0060.png)

然后如下图红框中设置连接本机的 MySQL8.0, 输入密码并点击 OK:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0061.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0062.png)

打开后的界⾯

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0063.png)

在中间的编辑器里, 就可以写 SQL 查询了.

下一次打开软件时, 可以直接点击保存的数据库连接, 不需要先进行设置后再连接了:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0064.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0065.png)

点击文件夹中的 heidisql.exe, 在弹出对话框里点击"新建", 然后填写密码, 再点击"打开"即可连接到本机上安装的 MySQL 数据库.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0066.png)

软件的主界面如图所示:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0067.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0068.png)

然后点击下一步:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0069.png)

在下方弹出的设置窗口中, "服务器地址"使用默认的localhost, "数据库"暂时留空, 然后在下方填入自己设置的密码, 最后点击测试连接.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0070.png)

本次学习主要使用一个新建的 shop 数据库, 但因为相关数据我们还没导入(建库建表及数据导入的脚本在本章第三节),因此数据库这里先留空. 等下一步导入数据后, 再进一步修改连接参数.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0071.png)

首次连接时会提示需要下载驱动程序,

完成驱动程序的下载后, 再次点击"测试连接",如果弹出如下对话框, 则表示连接成功:

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0072.png)

点击确定并保存连接后, 以后就可以直接双击这个连接进行数据库连接了.  如果需要保存多个数据库连接, 可以使用快捷键 F2 或选中当前连接并点击鼠标右键后选择"重命名"为当前连接起一个便于识别的名称.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0073.png)
...
![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0074.png)

注意, 在使用创建数据库的语句时, 是无需在红框中选中数据库的, 但其他所有的创建表,导入数据, 和最常用的查询语句, 都需要选中相应的数据库. 在执行上述语句后, 我们可以回到连接设置里, 把默认数据库连接改为刚才创建的 shop.

![图片](https://github.com/shenhao-stu/Datawhale_sql/raw/master/imgs/ch00/ch0075.png)
